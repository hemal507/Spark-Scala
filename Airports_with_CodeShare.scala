...
object AirportsZeroStops {
  ...
  def main(args: Array[String]) {
    ...
    val conf = new SparkConf().setMaster("local[2]").setAppName("airportscodeshare")
    ...
    val result1 = sqlContext.sql("select a.Airline, a.AirlineId, b.Name, b.Alias,a.SourceAirport,a.SourceAirportID,a.DestinationAirport,a.DestinationAirportID, a.CodeShare from routes a, airlines b where a.AirlineID = b.Airline and a.CodeShare = 'Y'")

    val result2 = result1.coalesce(2)

    result2.write.format("com.databricks.spark.csv").option("header", "true").save("Airports_CodeShare")
